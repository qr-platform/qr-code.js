...
export function useAutocomplete<T extends object>(
  ...
  let state = useComboBoxState({
    ...
    defaultFilter:
      defaultFilter && typeof defaultFilter === 'function' ? defaultFilter : contains,
  ...
  const getInputProps = () =>
    ({
      ...
      classNames: {
        ...slotsProps.inputProps.classNames,
        label: clsx(classNames?.label, slotsProps.inputProps.classNames?.label)
      }
      ...
      shouldCloseOnInteractOutside: popoverProps?.shouldCloseOnInteractOutside
        ...
        : (element: Element) =>
            ariaShouldCloseOnInteractOutside(
              element,
              inputWrapperRef as React.RefObject<Element>,
              state
            ),
